...
if room then
    ...
    Rock.ShearEvent.InteractPrompt.Triggered:Connect(function()
        if HasShears == false then
            HasShears = true
...
local exampleTool = game:GetObjects("rbxassetid://12816397372")[1]
...
local custom = {
    ...
    Desc = "I thought those were supposed to be in floor 1..?",  --first line

    Reason = "You picked up the Shears.", -- Balls

    BadgeId = 12759913548, --change badge id for image
